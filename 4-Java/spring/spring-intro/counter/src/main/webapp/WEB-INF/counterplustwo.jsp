...
<div class="container mx-auto p-5">
	<div class="card mx-auto p-5 text-center bg-secondary w-50">
		<h4 class="mb-5">Counter increment by two:<br/> Current counter:
		<strong><c:out value="${count}"/></strong></h4>
		<a href="/" class="btn btn-primary mb-2 fw-bold">Test Another Visit?</a>
		<a href="/counter/+2" class="btn btn-info mb-2 text-white fw-bold">Add Two More</a>
